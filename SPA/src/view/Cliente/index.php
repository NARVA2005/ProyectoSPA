...
<li class="nav-item dropdown no-arrow mx-1">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Reservas Mensuales
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Siempre pendiente del descanso de nuestros usuarios</h6>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Prevencion la hipertensión</h6>
                                   
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="chart-pie pt-4 pb-2">
                                      <img src="../../assets/pictures/pexels-john-tekeridis-21837-3212179.jpg" style="width: 100%;" alt="" srcset="">
                                    </div>
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Ofreciendo los mejores servicios de spa</h6>
            </div>
            <div class="card-body">
                <h4 class="small font-weight-bold">Masaje relajante<span class="float-right">20%</span></h4>
                <div class="progress mb-4">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: 20%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <h4 class="small font-weight-bold">Terapia facial<span class="float-right">40%</span></h4>
                <div class="progress mb-4">
                    <div class="progress-bar bg-warning" role="progressbar" style="width: 40%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <h4 class="small font-weight-bold">Tratamiento corporal<span class="float-right">60%</span></h4>
                <div class="progress mb-4">
                    <div class="progress-bar" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <h4 class="small font-weight-bold">Aromaterapia<span class="float-right">80%</span></h4>
                <div class="progress mb-4">
                    <div class="progress-bar bg-info" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <h4 class="small font-weight-bold">Spa de lujo<span class="float-right">100%</span></h4>
                <div class="progress">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Tu cuerpo lo necesita</h6>
        </div>
        <div class="card-body">
            <div class="text">
                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 100%;" src="../../assets/pictures/pexels-cottonbro-3997983.jpg" alt="...">
            </div>
            <p>Separa ya tu cita para que vivas de un momento inigualable</p>
