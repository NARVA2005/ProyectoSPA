...
<body id="page-top">
  ...
  <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Estos datos son tomados de acuerdo a la Informacion dada en en la base de datos del sistema. Puedes modificar los campos!!.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Datos regitrados en la base de datos Luurdes</h6>
                        </div>
                        <div class="card-body">
                            <div class="row bg-light text-dark">
                            
                                <div class="col-md-6">
                                    <label for="idPaciente">Cédula:</label>
                                    ...
                                    <label for="apellidoPaciente">Apellido completo:</label>
                                ...
                                <label for="emailPaciente">Email:</label>
                                    ...
                                    <label for="telefonoPaciente">Direccion:</label>
                                    <input type="text" name="direccionCliente" id="direccionCliente" class="form-control">
                                    <label for="movilPaciente">Celular:</label>
                                    <input type="text" name="movilPaciente" id="movilPaciente" class="form-control">
                                    <input type="hidden" name="usuario" id="password" class="form-control">
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <button type="button" id="btnEditar" class="btn btn-primary ov-btn-slide-right Editar" onclick="funcion_editarPaciente()">Editar</button>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="../js/datosPersonalesPacientes.js"></script>
