...
<body id="page-top">
    ...
    <div id="wrapper">
       ...
       General
        ...
        <li class="nav-item active">
            <a class="nav-link" href="citasRealizadas.html">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Estos datos son tomados, por las citas pendientes que tiene prgramadas con el doctor, si no le aparecen campos es por que no tiene citas programadas pendientes.</p>
