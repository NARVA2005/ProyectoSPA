document.addEventListener("DOMContentLoaded", function() {
    $.ajax({
        url: "../../Controller/Administrador/gestionTerapeutas.php",
        data:JSON.stringify(),
        type: "POST",
        ...
        success: function(data) {
            if (data.status === true) {
                var terapeutas = data.terapeutas;

                llenarTabla(terapeutas);
    ...
    function llenarTabla(terapeutas) {
        ...
        if (!$.fn.DataTable.isDataTable('#miTabla')) {
            $('#miTabla').DataTable({
                ...
                columns: [
                    ...
                    { data: 'CedulaTerapeuta' },
                    { data: 'CelularTerapeuta' },
                    { data: 'CorreoTerapeuta' },
                    {
                        targets: -1,
                        data: null,
            ...
            table.clear().draw();
            table.rows.add(terapeutas).draw();
        }
    }
});
